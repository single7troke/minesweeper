...
class Game:
    ...
    def draw_new_game_button(self, color, pressed=False):
        ...
        if pressed:
            ...
            self.font.render_to(self.screen, (int(x + self.cell_size / 2 + 2), int(y + self.cell_size / 3 + 2)), "New Game")
        else:
            ...
            self.font.render_to(self.screen, (int(x + self.cell_size / 2), int(y + self.cell_size / 3)), "New Game", (0, 0, 0))
